...
<AccordionGroup>
  <Accordion icon="github" title="Clone your docs locally">
    ...
    [dashboard](https://app.usequeue.com). To clone the repository
  ...
  <Accordion icon="rectangle-terminal" title="Preview changes">
    ...
    [Queue CLI](https://www.npmjs.com/package/queue) to preview the
    documentation changes locally with this command: `npm i -g queue`
    2\. Run the following command at the root of your documentation (where
    `mint.json` is): `queue dev`
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion icon="message-bot" title="Install our Github app">
    ...
    your [dashboard](https://app.usequeue.com). Once the bot has been
  ...
  <Accordion icon="rocket" title="Push your changes">
    ...
    update your docs through our [dashboard](https://app.usequeue.com).
  </Accordion>
</AccordionGroup>
